...
//*********************************************************
public class RefPercentLayoutHelper {
  private static final String TAG = "PercentLayout";
  private final ViewGroup mHost;

  public RefPercentLayoutHelper(ViewGroup host) {
    this.mHost = host;
  }
  ...
  public void adjustChildren(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    for(int N = this.mHost.getChildCount(); i < N; ++i) {
      ...
      if(params instanceof RefPercentLayoutHelper.PercentLayoutParams) {
        RefPercentLayoutHelper.PercentLayoutInfo info = ((RefPercentLayoutHelper.PercentLayoutParams)params).getPercentLayoutInfo();
        if(Log.isLoggable("PercentLayout", Log.DEBUG)) {
  ...
  public static RefPercentLayoutHelper.PercentLayoutInfo getPercentLayoutInfo(Context context, AttributeSet attrs) {
    RefPercentLayoutHelper.PercentLayoutInfo info = null;
    ...
    if(value != -1.0F) {
      ...
      info = info != null?info:new RefPercentLayoutHelper.PercentLayoutInfo();
  ...
  private static boolean shouldHandleMeasuredWidthTooSmall(View view, RefPercentLayoutHelper.PercentLayoutInfo info) {
  ...
  private static boolean shouldHandleMeasuredHeightTooSmall(View view, RefPercentLayoutHelper.PercentLayoutInfo info) {
  ...
  public interface PercentLayoutParams {
    RefPercentLayoutHelper.PercentLayoutInfo getPercentLayoutInfo();
  }
